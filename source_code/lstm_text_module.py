...
class TextModule:
    ...
    def load_model(self, path: str) -> bool:
        ...
        try:
            ...
            lstm1 = Bidirectional(LSTM(32, return_sequences=True, activation=activation))(embedding)
            lstm2 = Bidirectional(LSTM(32, activation=activation))(lstm1)

            dens1 = Dense(64, activation='relu')(lstm2)
            drop1 = Dropout(0.5)(dens1)
            dens2 = Dense(8, activation='relu')(drop1)
            predict = Dense(2, activation='softmax')(dens2)
...
if __name__ == '__main__':
    ...
    text_module.load_model(path="Model_checkpoint//lstm_weights(2023-11-07).h5")
